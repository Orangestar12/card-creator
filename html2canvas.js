    ...
    ***************************************************************************** */
    ...
    var CSSParsedDeclaration = /** @class */ (function () {
        function CSSParsedDeclaration(declaration) {
            this.animationDuration = parse(duration$1, declaration.animationDuration);
            ...
            this.transitionDuration = parse(duration$1, declaration.transitionDuration);
        ...
        switch (descriptor.type) {
            ...
            case PropertyDescriptorParsingType.TYPE_VALUE:
                switch (descriptor.format) {
                    ...
                    case 'duration':
                        return duration.parse(parser.parseComponentValue());
                }
        }
    ...
    var ElementContainer = /** @class */ (function () {
        function ElementContainer(element) {
            ...
            var ad = this.styles.animationDuration;
            var td = this.styles.transitionDuration;
    ...
    var SVGElementContainer = /** @class */ (function (_super) {
        ...
        function SVGElementContainer(img) {
            var _this = _super.call(this, img) || this;
            var textElem = img.getElementsByTagName('text');
            for (var i = 0; i < textElem.length; i++) {
                var e = textElem[i];
                if (window.getComputedStyle(img, null).getPropertyValue('font-family')) {
                    e.setAttribute('font-family', window.getComputedStyle(img, null).getPropertyValue('font-family'));
                    e.replaceWith(e);
                }
            }
